####################################################################
# EXPERIMENTO 09 - CLASSIFICADORES KNN E REGRESSÃO LOGÍSTICA
#                  PARA CONJUNTO ORANGE
#
...
#-------------------------------------------------------------------------
# Verificar a variação da acurácia para REGRESSAO LOGÍSTICA
#-------------------------------------------------------------------------

print('\n Variação da acuráciapara REGRESSAO LOGÍSTICA')
#print('\n       C         TREINO  TESTE ')
#print(' --------------  ------  -----')
